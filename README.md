...
- `dmsta_inputparams_all.csv`
  - Input parameters used in DMSTA and DMSTAr simulations for each STA
    and project used in the evaluation
- `dmstar_inputs.rds`
...
- `dat_proc.R`
  - Data accumulation and organization from the various DMSTA output
    files.
- `dat_analyze.R`
